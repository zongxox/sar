...
public class ExcelExportUtil0206 {
     ...
     */
    public static byte[] buildApplyDetailExcel(List<TicketUpd0206Res> rows, boolean isXls) throws Exception {
        ...
        try (
            ...
            createTextCell(header, c++, "使用者名稱", leftStyle);//12
            createTextCell(header, c++, "問題標題", leftStyle);//1
            createTextCell(header, c++, "問題內容", leftStyle);//2
            createTextCell(header, c++, "問題類型", leftStyle);//3
            createTextCell(header, c++, "優先順序", leftStyle);//4
            createTextCell(header, c++, "處理狀態", leftStyle);//5
            createTextCell(header, c++, "聯絡方式", leftStyle);//6
            ...
            for (TicketUpd0206Res res : rows) {
                ...
                createTextCell(row, col++, res.getContact(), dateStyle);
