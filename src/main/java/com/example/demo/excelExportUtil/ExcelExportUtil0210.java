...
public class ExcelExportUtil0210 {
     ...
     */
    public static byte[] buildApplyDetailExcel(List<OrderShipmentDon0210Res> rows, boolean isXls) throws Exception {
        ...
        try (
            ...
            for (OrderShipmentDon0210Res res : rows) {
