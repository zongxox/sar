...
public class ExcelExportUtil0211 {
     ...
     */
    public static byte[] buildApplyDetailExcel(List<OrdersDon0211Res> rows, boolean isXls) throws Exception {
        ...
        try (
            ...
            createTextCell(header, c++, "金額", leftStyle);//1
            createTextCell(header, c++, "狀態", leftStyle);//2
            createTextCell(header, c++, "備註", leftStyle);//3
            createTextCell(header, c++, "訂單類型", leftStyle);//4
            createTextCell(header, c++, "來源", leftStyle);//5
            createTextCell(header, c++, "客戶名稱", leftStyle);//6
            ...
            for (OrdersDon0211Res res : rows) {
                ...
                createTextCell(row, col++, n(res.getOrderType()), leftStyle);

                createTextCell(row, col++, n(res.getSource()), leftStyle);

                createTextCell(row, col++, res.getCustomer(), dateStyle);
